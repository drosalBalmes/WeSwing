...
public class ProfessorFragment extends Fragment implements SelectListenerProfessors {
    ...
    public void initRecyclerReview() {
        ...
        userList.add(new User("Loffy sisi", R.drawable.luffy_g5_glasses));
        userList.add(new User("Lucy", R.drawable.luffy_g5_glasses));
        userList.add(new User("El luffy gordo", R.drawable.luffy_g5_glasses));
        userList.add(new User("Un fan de OP", R.drawable.luffy_g5_glasses));
